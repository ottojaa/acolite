...
var getFileEntityFromPath = function (filePath) {
    ...
    return __assign({ filePath: filePath, ino: fileInfo.ino, parentPath: file_utils_1.getDirName(filePath), type: isFolder ? 'folder' : 'file', size: fileInfo.size, createdAt: fileInfo.birthtime, modifiedAt: fileInfo.mtime }, (!isFolder && { fileExtension: fileExtension }));
};
