...
import { folderNameValidationPattern } from '../../../../../../app/shared/constants'
...
export class FolderCreationDialogComponent {
  folderName = new FormControl('', [Validators.required, Validators.pattern(folderNameValidationPattern)])
